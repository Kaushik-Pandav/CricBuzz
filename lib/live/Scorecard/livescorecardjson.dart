class Livescorecardjson {
  ...
  factory Livescorecardjson.fromJson(Map<dynamic, dynamic> json) {
...
class MatchHeader {
  ...
  factory MatchHeader.fromJson(Map<String, dynamic> json) {
    return MatchHeader(
      ...
      status: json["status"],
      tossResults:
          json["tossResults"] == null
              ? null
              : RevisedTarget.fromJson(json["tossResults"]),
      result: json["result"] == null ? null : Result.fromJson(json["result"]),
      revisedTarget:
          json["revisedTarget"] == null
              ? null
              : RevisedTarget.fromJson(json["revisedTarget"]),
      playersOfTheMatch:
          json["playersOfTheMatch"] == null
              ? []
              : List<PlayersOfThe>.from(
                json["playersOfTheMatch"]!.map((x) => PlayersOfThe.fromJson(x)),
              ),
      playersOfTheSeries:
          json["playersOfTheSeries"] == null
              ? []
              : List<PlayersOfThe>.from(
                json["playersOfTheSeries"]!.map(
                  (x) => PlayersOfThe.fromJson(x),
                ),
              ),
      matchTeamInfo:
          json["matchTeamInfo"] == null
              ? []
...
class ScoreCard {
  ...
  factory ScoreCard.fromJson(Map<String, dynamic> json) {
    return ScoreCard(
      ...
      batTeamDetails:
          json["batTeamDetails"] == null
              ? null
              : BatTeamDetails.fromJson(json["batTeamDetails"]),
      bowlTeamDetails:
          json["bowlTeamDetails"] == null
              ? null
      ...
      wicketsData: Map.from(json["wicketsData"]).map(
        (k, v) => MapEntry<String, WicketsDatum>(k, WicketsDatum.fromJson(v)),
      ),
      partnershipsData: Map.from(json["partnershipsData"]).map(
        (k, v) => MapEntry<String, PartnershipsDatum>(
          k,
          PartnershipsDatum.fromJson(v),
        ),
      ),
    );
  }
...
class BatTeamDetails {
  ...
  factory BatTeamDetails.fromJson(Map<String, dynamic> json) {
    return BatTeamDetails(
      ...
      batsmenData: Map.from(json["batsmenData"]).map(
        (k, v) => MapEntry<String, BatsmenDatum>(k, BatsmenDatum.fromJson(v)),
      ),
    );
  }
}
